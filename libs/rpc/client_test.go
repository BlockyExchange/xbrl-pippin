...
func TestGetAccountsBalances(t *testing.T) {
	...
	resp, err := MockRpcClient.MakeAccountsBalancesRequest([]string{"xbrl_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3"})
	assert.Nil(t, err)
	balances := *resp.Balances
	assert.Equal(t, "11999999999999999918751838129509869131", balances["xbrl_1gyeqc6u5j3oaxbe5qy1hyz3q745a318kh8h9ocnpan7fuxnq85cxqboapu5"].Balance)
}
...
func TestGetAccountBalance(t *testing.T) {
	...
	resp, err := MockRpcClient.MakeAccountBalanceRequest("xbrl_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3")
	assert.Nil(t, err)
...
func TestGetAccountsFrontiers(t *testing.T) {
	...
	resp, err := MockRpcClient.MakeAccountsFrontiersRequest([]string{"xbrl_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3"})
	assert.Nil(t, err)
	frontiers := *resp.Frontiers
	assert.Equal(t, "791AF413173EEE674A6FCF633B5DFC0F3C33F397F0DA08E987D9E0741D40D81A", frontiers["xbrl_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3"])
	assert.Equal(t, "6A32397F4E95AF025DE29D9BF1ACE864D5404362258E06489FABDBA9DCCC046F", frontiers["xbrl_3i1aq1cchnmbn9x5rsbap8b15akfh7wj7pwskuzi7ahz8oq6cobd99d4r3b7"])
}
...
func TestGetAccountsPending(t *testing.T) {
	...
	resp, err := MockRpcClient.MakeAccountsPendingRequest([]string{"xbrl_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3"})
	assert.Nil(t, err)
	blocks := *resp.Blocks
	assert.Equal(t, "4C1FEEF0BEA7F50BE35489A1233FE002B212DEA554B55B1B470D78BD8F210C74", blocks["xbrl_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3"][0])
	assert.Equal(t, "142A538F36833D1CC78B94E11C766F75818F8B940771335C6C1B8AB880C5BB1D", blocks["xbrl_1111111111111111111111111111111111111111111111111117353trpda"][0])
}
...
func TestMakeBlockInfoRequest(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, "xbrl_1ipx847tk8o46pwxt5qjdbncjqcbwcc1rrmqnkztrfjy5k7z4imsrata9est", resp.BlockAccount)
	...
	assert.Equal(t, "xbrl_1ipx847tk8o46pwxt5qjdbncjqcbwcc1rrmqnkztrfjy5k7z4imsrata9est", resp.Contents.Account)
	assert.Equal(t, "CE898C131AAEE25E05362F247760F8A3ACF34A9796A5AE0D9204E86B0637965E", resp.Contents.Previous)
	assert.Equal(t, "xbrl_1stofnrxuz3cai7ze75o174bpm7scwj9jn3nxsn8ntzg784jf1gzn1jjdkou", resp.Contents.Representative)
	...
	assert.Equal(t, "xbrl_1qato4k7z3spc8gq1zyd8xeqfbzsoxwo36a45ozbrxcatut7up8ohyardu1z", resp.Contents.LinkAsAccount)
...
func TestMakeAccountInfoRequest(t *testing.T) {
	...
	assert.Equal(t, "xbrl_1gyeqc6u5j3oaxbe5qy1hyz3q745a318kh8h9ocnpan7fuxnq85cxqboapu5", resp.Representative)
