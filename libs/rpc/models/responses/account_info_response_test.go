...
func TestDecodeAccountInfoResponse(t *testing.T) {
	...
	assert.Equal(t, "xbrl_1gyeqc6u5j3oaxbe5qy1hyz3q745a318kh8h9ocnpan7fuxnq85cxqboapu5", decoded.Representative)
