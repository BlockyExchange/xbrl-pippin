...
func TestAddressToPub(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, "dba12a8ed2702404483f5519c2b24e3c2f9cfc92310ab43255f3f6369e27a527", hex.EncodeToString(pub))
	address = "xbrl_3px37c9f6w361j65yoasrcs6wh3hmmyb6eacpis7dwzp8th4hbb9izgba51j"
	pub, err = AddressToPub(address, false)
	assert.Nil(t, err)
	assert.Equal(t, "dba12a8ed2702404483f5519c2b24e3c2f9cfc92310ab43255f3f6369e27a527", hex.EncodeToString(pub))

	// Invalid
	address = "xbrl_3px37c9f6w361j65yoasrcs6wh3hmmyb6eacpis7dwzp8th4hbb9izgba511"
	pub, err = AddressToPub(address, false)
	assert.NotNil(t, err)
...
func TestPubkeyToAddress(t *testing.T) {
	...
	assert.Equal(t, "xbrl_1p95xji1g5gou8auj8h6qcuezpdpcyoqmawao6mpwj4p44939oouoturkggc", address)
